...
#taking Bucklin Point influent and effluent reportable avg concentrations.
...
#is result dependent on the type of PFAS compound
...
#filter data by SIU and reportable average concentrations
